package com.assign.quizeonline.service;

import com.assign.quizeonline.model.Question;
import com.assign.quizeonline.repository.QuestionRepository;
...
public class QuestionService implements IQuestionService {
    ...
    public List<Question> getQuestionsForUser(Integer numOfQuestions, String subject) {
        ...
        return Collections.singletonList((Question) questionRepository.findBySubject(subject, pageable).getContent());
