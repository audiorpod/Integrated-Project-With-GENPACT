...
export const price = [
  {
    name: "BASIC PLAN",
    price: "49K",
    desc: "Access to basic features and Basic Courses Recorded",
  },
  {
    name: "BEGINNER PLAN",
    price: "79K",
    desc: "Access to all intermediate courses and live lecture every sunday ",
  },
  {
    name: "PREMIUM PLAN",
    price: "109k",
    desc: "Live classes With instructor for doubt solving 3 times a week ",
  },
  {
    name: "ULTIMATE PLAN",
    price: "149K",
    desc: "You can access all other courses and test with live instructor 6 day a week",
  },
]
export const faq = [
  {
